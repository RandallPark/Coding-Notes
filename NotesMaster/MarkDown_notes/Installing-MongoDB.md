...
2. If successful, you should now how a `/data/db` directory in your root folder. You can verify this by running `cd /data/db` in your terminal. If you are able to cd into the folder, then move on to the next step.
